...
public class Query extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       gradientDrawable.setColors(colorsa);
        ...
        reference=FirebaseDatabase.getInstance().getReference().child("Questions").child(String.valueOf(1));
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(next[0]==1)
                {
                    Intent i=new Intent(Query.this,questionb.class);
                    i.putExtra("res",
                            right);
                    startActivity(i);
                    customType(Query.this,"Right To Left");
