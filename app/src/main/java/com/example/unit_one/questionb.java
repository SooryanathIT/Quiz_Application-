...
public class questionb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questionb);
        ...
        reference=FirebaseDatabase.getInstance().getReference().child("Questions").child(String.valueOf(2));
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(next[0]==1)
                {
                    ...
                    Intent i=new Intent(questionb.this,questionc.class);
                    Intent j=getIntent();
                    ...
                    i.putExtra("res",
                            right);
                    startActivity(i);
                    customType(questionb.this,"Right To Left");
