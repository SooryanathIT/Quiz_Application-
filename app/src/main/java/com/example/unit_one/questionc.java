...
public class questionc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questionc);
        ...
        reference=FirebaseDatabase.getInstance().getReference().child("Questions").child(String.valueOf(3));
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(next[0]==1)
                {
                    Intent i=new Intent(questionc.this,questiond.class);
                    Intent j=getIntent();
                    ...
                    i.putExtra("res",
                            right);
                    startActivity(i);
                    customType(questionc.this,"Right To Left");
