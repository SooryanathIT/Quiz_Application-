...
public class questiond extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questiond);
        ...
        reference=FirebaseDatabase.getInstance().getReference().child("Questions").child(String.valueOf(4));
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(next[0]==1)
                {
                    Intent i=new Intent(questiond.this,questione.class);
                    Intent j=getIntent();
                    ...
                    i.putExtra("res",
                            right);
                    startActivity(i);
                    customType(questiond.this,"Right To Left");
