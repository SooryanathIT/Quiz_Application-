...
public class questionf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questionf);
        ...
        reference=FirebaseDatabase.getInstance().getReference().child("Questions").child(String.valueOf(6));
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(next[0]==1)
                {
                    Intent i=new Intent(questionf.this,questiong.class);
                    Intent j=getIntent();
                    ...
                    i.putExtra("res",
                            right);
                    startActivity(i);
                    customType(questionf.this,"Right To Left");
