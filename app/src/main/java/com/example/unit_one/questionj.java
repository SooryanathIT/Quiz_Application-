...
public class questionj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questionj);
        ...
        reference=FirebaseDatabase.getInstance().getReference().child("Questions").child(String.valueOf(10));
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(next[0]==1)
                {
                    Intent i=new Intent(questionj.this,results.class);

                    Intent j=getIntent();
                    int res=j.getIntExtra("res",0);
                    right=res+right;
                    i.putExtra("res",right);
                    startActivity(i);
                    customType(questionj.this,"Right To Left");
