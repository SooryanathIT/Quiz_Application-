...
public class questioni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questioni);
        ...
        reference=FirebaseDatabase.getInstance().getReference().child("Questions").child(String.valueOf(9));
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(next[0]==1)
                {
                    Intent i=new Intent(questioni.this,questionj.class);
                    Intent j=getIntent();
                    ...
                    i.putExtra("res",
                            right);
                    startActivity(i);
                    customType(questioni.this,"Right To Left");
